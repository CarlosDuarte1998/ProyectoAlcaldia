    ...
    <div class="w3-container">
        <div id="id01" class="w3-modal">
            <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:700px">
                ...
                <form class="w3-container" method="post" action="mant_clientes.php">
                    <div class="w3-section">
                        <label><b>Nombre</b></label>
                        <input class="w3-input w3-border " type="text" maxlength="10" placeholder="Escriba el Nombre" name="nombre" required 
                        pattern="[A-Za-z]+" title="No se permiten Numeros"> 
                            

                        <label><b>Apellido</b></label>
                        <input class="w3-input w3-border" type="text" maxlength="10" placeholder="Escriba los Apellidos"
                            name="apellido" required pattern="[A-Za-z]+" title="No se permiten Numeros">

                        <label><b>Telefono celular</b></label>
                        <input class="w3-input w3-border" type="text" placeholder="Escriba el Telefono"
                            name="telefono_personal" id="telp" required pattern="[0-9]+" title="No se permiten Letras" maxlength="8">

                        <label><b>Telefono fijo</b></label>
                        <input class="w3-input w3-border" type="text" placeholder="Escriba el Telefono"
                            name="telefono_fijo" id="telc" required pattern="[0-9]+" title="No se permiten Letras" maxlength="8">

                        <label><b>Dirección</b></label>
                        <input class="w3-input w3-border" type="text" placeholder="Escriba la dirección"
                        ...
                        <label><b>DUI</b></label>
                        <input class="w3-input w3-border" type="text" placeholder="Escriba el número de DUI" name="dui"
                            required pattern="[0-9\-]+" title="No se permiten Letras" maxlength="10">
                        <label><b>NIT</b></label>
                        <input class="w3-input w3-border" type="text" placeholder="Escriba el número de NIT" name="nit"
                            required   pattern="[0-9\-]+" title="No se permiten Letras" maxlength="17">
                        <label><b>Fecha de Nacimiento</b></label>
                        <input class="w3-input w3-border" type="date" placeholder="Escriba la Fecha de Nacimiento"
                            name="fecha" max="2004-01-01" required>
