...
if (isset($_POST['send_insert'])) {
  ...
  echo " <script>window.location.replace('./index.php?x=cargosvarios.php')</script>";
    ...
    <div id="id01" class="w3-modal">
      <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:700px">
        <div class="w3-center"><br>
          <a href="index.php?x=cargosvarios.php"> <span class="w3-button w3-xlarge w3-hover-red w3-display-topright" title="Close Modal">&times;</span></a>
        ...
        <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
          <a href="index.php?x=cargosvarios.php" class="w3-button w3-red">Cancel</a>
        </div>
      </div>
    </div>
    <!-- FIN del MODAL -->
