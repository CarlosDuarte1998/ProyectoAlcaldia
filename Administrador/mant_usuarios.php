        ...
        <form class="w3-container" method="post" action="">
          <div class="w3-section">
            ...
            <!-- Llenado de los Valores(propiedad Value) de los Inputs -->
              ...
              <label><b>Seleccione el Tipo (Administrador o Auxiliar)</b></label>
             <select name="tipo" id="tipo" class="w3-input w3-border">
             <?php
             if ($rol == 1) {
                 echo ' <option value="1" selected=true>Auxiliar</option>
                        <option value="2">Administrador</option>';
                        $parti= "block";
                        $doc="none";
             }else{
                echo ' <option value="1">Auxiliar</option>
                <option value="2" selected=true>Administrador</option>';
                    $parti= "none";
                        $doc="block";    
             }
             ?>
